                ...
                <Container className="content-container">
                    <Column>
                        ...
                        >
                            ...
                            <strong>АВГ, 2022</strong>
                            <Hr/>
                            <p>Спасибо за классное начало дня! Все было очень здорово, увлекательно и весело! Ребёнок
                                счастлив :)</p>
                        </ArticleEven>
                    </Column>
                    <ArticleBig
                    ...
                    >
                        ...
                        <Hr/>
                        <p>Я воспитатель с большим стажем, работала в муниципальных и частных детских садах. Впервые
                            вижу насколько все продуманно до мелочей: шкафчики с антресолью для хранения одежды, рабочие
                            места воспитателям, комфортные места для занятий, отдельная зона для игры, уютная столовая с
                            красивой посудой и многое другое. Замечательная детская площадка. Поздравляю с открытием.</p>
                    </ArticleBig>
                </Container>
                <br/>
